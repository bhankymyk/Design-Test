        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td className="px-6 py-4 text-sm">207.40.22.358</td>
              <td className="px-6 py-4 text-sm">3 days ago</td>
            ...
            <tr className="odd:bg-white odd:dark:bg-gray-900  even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td className="px-6 py-4">Safari IOS</td>
              <td className="px-6 py-4 text-sm">207.40.22.358</td>
              <td className="px-6 py-4 text-sm">3 days ago</td>
              <td className="px-6 py-4">
                <button
            ...
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td className="px-6 py-4">Chrome Windows</td>
              <td className="px-6 py-4 text-sm">207.40.22.358</td>
              <td className="px-6 py-4 text-sm">Last Week</td>
              <td className="px-6 py-4">
                <button
                  type="button"
