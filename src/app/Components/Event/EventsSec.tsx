              ...
              <button
                ...
                <div className="flex justify-between mt-10 border border-2 rounded-sm p-3">
                  <div className="div py-3"> 
                      <p className="font-semibold text-lg">Design Workshop  <span className="font-normal text-sm">/alex/design</span></p>
                      <p>A longer chat to run through designs</p>
                    
                      <div className="flex  bg-gray-500 w-[80px] ">
                      <Image src='/assets/clock.svg' width={20} height={20} alt='' className=''/>
                  ...
                  <Image src='/assets/Toggle.svg' width={40} height={40} alt='' className=''/>
                  <Image src='/assets/Moore.svg' width={100} height={100} alt='' className='ml-3'/>
                  </div>
                </div>

                <div className="flex justify-between  border border-2 rounded-sm p-3">
                  <div className="div"> 
                      <p className="font-semibold text-lg">30 minute meeting  <span className="text-sm font-normal">/alex/design</span></p>
                      <p>A longer chat to run through designs</p>
                      <div className="flex  bg-gray-500 w-[80px] ">
